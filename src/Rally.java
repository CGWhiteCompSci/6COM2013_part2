...
public class Rally extends Competitor{
    ...
    public static ArrayList<Competitor> loadData(String driverListLocation) {
        ...
        int tempID = 0;
        String tempName, tempDoB, tempLevel, tempCountry, tempEmail, tempDriveTrain;
        tempName = tempDoB = tempLevel = tempCountry = tempEmail = tempDriveTrain = "";
            ...
            while (myReader.hasNextLine()) {
                ...
                if ((lineofdata.length >= 5)) {
                    ...
                    if (errorFlag == Boolean.FALSE) {
                        ...
                        Rally tempRally = new Rally(tempID,new Name(tempName),tempDoB,tempLevel,tempCountry,tempEmail,tempDriver,tempDriveTrain);
                        tempCompetitors.add(tempRally);
